...
ap.add_argument("-o", "--output", type=str, default="results.csv",)  # esse é o arquivo que vai ser salvo com os dados que foram lidos.
args = vars(ap.parse_args())

# Iniciar a stream (iniciar a webcam) e permitir que o sensor da câmera aqueça
print("[INFO] Starting the stream and CSV file")
...
while True:
    ...
    # Frame name
    cv2.imshow("Time Recording", frame)
...
# fecha o arquivo CSV
print("[INFO] Finiscing the stream and closing the CSV file...")
csv.close()
